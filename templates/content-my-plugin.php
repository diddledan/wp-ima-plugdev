<div class="plugin-directory-plugin">
    ...
    <p><a href="<?php echo esc_attr( get_ima_plugdev_plugin_zip() ); ?>">Download <?php the_title(); ?> version <?php ima_plugdev_plugin_version(); ?></a></p>

    <div>
        <?php ima_plugdev_plugin_description(); ?>
    </div>
</div>